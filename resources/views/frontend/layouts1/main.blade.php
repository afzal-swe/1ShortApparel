			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						...
						@else
						{{-- <div class="banner_price"><span>{{ $setting->currency }}{{ $banner->product_price }}</span>{{ $setting->currency }}{{ $banner->discount_price }}</div> --}}
						@endif
...
@endif
    	<!-- Characteristics -->
		@php
			$brand = DB::table('brands')->where('status', 1)->orderBy('id', 'DESC')->limit(24)->get();
		@endphp
							...
							<div class="col-lg-1 col-md-6 char_col" style="border:1px solid grey; padding:5px;">
								<div class="brands_item">
									<a href="#" title="{{ $row->name }}">
										<img src="{{ asset ($row->image)}}" alt="{{ $row->name }}" height="100%" width="100%">
									</a>
								</div>
							</div>
						@endforeach
				...
				<div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
							...
							<div class="owl-carousel owl-theme deals_slider">
								...
								@foreach ( $today_deal as $deal)
									<div class="owl-item deals_item">
										<div class="deals_image"><img src="{{ asset ($deal->thumbnail)}}" alt="{{ $banner->product_title }}"></div>
										<div class="deals_content">
											<div class="deals_info_line d-flex flex-row justify-content-start">
												{{-- <div class="deals_item_category"><a href="#">{{ $deal->category->category_name }}</a></div> --}}
												@if ($deal->discount_price==Null)
													{{-- <div class="deals_item_price_a ml-auto">{{ $setting->currency }}{{ $deal->product_price }}</div> --}}
												@else
													{{-- <div class="deals_item_price_a ml-auto">{{ $setting->currency }}{{ $deal->discount_price }}</div> --}}
												@endif
											</div>
											<div class="deals_info_line d-flex flex-row justify-content-start">
					...
					<div class="featured">
						<div class="tabbed_container">
							...
							@php
								$featured = DB::table('products')->where('status', 1)->orderBy('id', 'DESC')->limit(16)->get();
							@endphp
							<!-- Product Panel -->
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content" style="margin-top: -60px;">
												...
												@if ($row->discount_price==Null)
													{{-- <div class="product_price discount">{{ $setting->currency }}{{ $row->product_price }}</div> --}}
												@else
													{{-- <div class="product_price discount">{{ $setting->currency }}{{ $row->discount_price }}<span>{{ $setting->currency }}{{ $row->product_price }}</span></div> --}}
												@endif
								...
								<div class="owl-item">
									<a href="">
										<div class="popular_category d-flex flex-column align-items-center justify-content-center">
											<div class="popular_category_image"><img src="{{ asset ($row->image)}}" alt=""></div>
	...
	@php
		$product_category = DB::table('categories')->where('category_status', 1)->get();
	@endphp
									...
									<div class="arrivals_slider slider">
										...
										@foreach ($cat_product as $row)
											<div class="featured_slider_item">
												<div class="border_active"></div>
												<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
													<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset ($row->thumbnail)}}" alt="{{ $row->product_title }}" height="100%" width="60%"></div>
												<div class="product_content" style="margin-top: -60px;">
													{{-- <div class="product_price discount">$225<span>$300</span></div> --}}
													@if ($row->discount_price==Null)
														{{-- <div class="product_price discount">{{ $setting->currency }}{{ $row->product_price }}</div> --}}
...
{{-- 
	...
	@php
		$trendy = DB::table('products')->where('status', 1)->where('trendy', 1)->orderBy('id', 'DESC')->limit(6)->get();
	@endphp
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="trends_container">
						...
						<div class="trends_text"><p>This year best trendy product for your</p></div>
							...
							@foreach ($trendy as $row)
									...
									<div class="owl-item">
										<div class="trends_item is_new">
											<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset ($row->thumbnail)}}" alt=""></div>
											<div class="trends_content">
												<div class="trends_category"><a href="#">Smartphones</a></div>
												<div class="trends_info clearfix">
													<div class="trends_name"><div><a href="{{ route('product.details',$row->slug) }}">{{ substr($row->product_title,0,20) }}..</a></div></div>
													
													@if ($row->discount_price==Null)
														<div class="trends_price">{{ $setting->currency }}{{ $row->product_price }}</div>
													@else
														{{-- <div class="trends_price">{{ $setting->currency }}{{ $row->discount_price }} <del class="text-danger">{{ $setting->currency }}{{ $row->product_price }}</del></div> --}}
													@endif
												</div>
											</div>
							...
							@foreach ($top_view_product as $row)
								...
								<div class="owl-item">
									<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
										...
										{{-- <div class="product_price discount">$225<span>$300</span></div> --}}
											@if ($row->discount_price==Null)
												{{-- <div class="viewed_price">{{ $setting->currency }}{{ $row->product_price }}</div> --}}
											@else
												{{-- <div class="viewed_price">{{ $setting->currency }}{{ $row->discount_price }}<span>{{ $setting->currency }}{{ $row->product_price }}</span></div> --}}
											@endif
											{{-- <div class="viewed_name"><div><a href="{{ route('product.details',$row->slug) }}">{{ substr($row->product_title,0,20) }}..</a></div></div> --}}
										</div>
									</div>
								</div>
							@endforeach
